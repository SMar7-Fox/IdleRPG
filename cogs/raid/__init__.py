...
""",
        ...
        await asyncio.sleep(150)
        await ctx.send("**Asmodeus brings those with a strong heart back to life.**")
        await asyncio.sleep(150)
        ...
        await asyncio.sleep(60)
        await ctx.send("**The Goddess of Wisdom provides you rage. For every defender that dies, the remaining get increased damage and shield.**)
        await asyncio.sleep(60)
